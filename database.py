...
DEFAULT_SETTINGS = {
    "store_name": "QELVORIA",
    "store_tagline": "Premium Digital Publishing & Ebook Bundles",
    "store_currency": "₹",
    "currency_code": "INR",
    "support_email": "support@qelvoria.com",
    "support_whatsapp": "",
    "email_sender_name": "QELVORIA Publishing",
    "email_from_address": "support@qelvoria.com",
    "smtp_enabled": "false",
    ...
    "announcement_text": "🎉 Welcome to QELVORIA: Use coupon code QELVORIA20 for 20% OFF! Instant delivery.",
    "announcement_coupon": "QELVORIA20",
        ...
        async with db.execute("SELECT COUNT(*) FROM coupons") as cursor:
            ...
            if coupon_count == 0:
                await db.execute("""
                    ...
                    VALUES 
                    ('QELVORIA20', 'percentage', 20.0, 0, 1000, 1),
